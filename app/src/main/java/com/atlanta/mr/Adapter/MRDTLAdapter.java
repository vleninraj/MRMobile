...
import com.atlanta.mr.ViewHolder.ViewHolderMRDTL;


import java.util.ArrayList;
import java.util.Collections;

public class MRDTLAdapter extends BaseAdapter {

    private static final String TAG = "POSDTLAdapter";
    Activity _context;
    ArrayList<MRDTL> _positems;

    public MRDTLAdapter(Activity  context, ArrayList<MRDTL> positems) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View vw=view;
        final MRDTL _positem = (MRDTL) this.getItem(i);
        if(vw==null)
        {
            ...
            final ViewHolderMRDTL _viewholder=new ViewHolderMRDTL(vw);
            ...
            final ViewHolderMRDTL _viewholder=(ViewHolderMRDTL) vw.getTag();
            _viewholder.tvproductname.setText(_positem.get_ProductName());
            _viewholder.tvproductname.setTag(_positem.get_productid());
            _viewholder.tvproductcode.setText(_positem.get_ProductCode());
            _viewholder.tvqty.setText(String.format(Common.sDecimalsQty,_positem.get_Qty()));
